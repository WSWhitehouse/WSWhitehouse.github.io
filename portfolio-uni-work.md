...
The Pong game is a simple clone of the original game. It includes a two player mode, where two people play against each other. A one player mode, where one person plays against an AI opponent. In both modes there are multiple difficulties, these difficulties change the speed of the ball to make it harder or easier to hit it. Below is a short video of the game played with two players in normal difficulty:
